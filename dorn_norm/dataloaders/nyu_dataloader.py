...
alpha, beta = 0.697676, 10.5909  # NYU Depth, min depth is 0.02m, max depth is 10.0m
...
class NYUDataset(MyDataloader):
    ...
    def get_depth_sid(self, depth):
        ...
        print(np.where(depth<alpha),'depth<alpha')
